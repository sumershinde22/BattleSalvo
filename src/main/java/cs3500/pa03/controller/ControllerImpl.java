...
/**
 * The ControllerImpl class is responsible for controlling the flow of the game and managing the interaction
...
public class ControllerImpl implements Controller {
   ...
   * The game is initialized with a GameImpl instance and the view is initialized with a ViewImpl instance.
   */
   ...
   * Shows the AI board and human board on the view by calling showAIBoard() and showHumanBoard() respectively.
