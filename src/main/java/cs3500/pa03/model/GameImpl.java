...
public class GameImpl implements Game {
   ...
   * @param shipsNums   A map of ship types and their corresponding numbers to be placed on the board.
   * @return A list of two 2D char arrays representing the AI player's board and the human player's board.
   */
  @Override
  public List<char[][]> setUpBoard(int boardHeight, int boardWidth,
    ...
    manualPlayer.setBoard(playerBoard, aiBoard);
